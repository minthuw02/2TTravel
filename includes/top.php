	...
	<div id="wrapper">
			...
			<div class="bot_header">
				<div class="navbar_header">
					<div class="container">
							...
							<div class="col-lg-12 sm_hidden">
								<nav class="header_nav">
									<ul class="item_big">
										...
										<li class="nav_item"><a href="gioi-thieu.html" title="Giới thiệu">Giới thiệu</a></li>
										<li class="nav_item">
                        ...
                        ?>
							...
							<?php 
								// count number tour
								$total_p = "SELECT count(sku_tour) as tong_sp FROM tour WHERE flag = 1 AND id_type = $id_type";
						...
						?>
										...
										<li class="nav_item">
											<a href="#" title="Tin tức" onclick="return false;">
												<span> Tin tức </span>
												<i class="fa fa-caret-down"></i>
											</a>
											<ul class="item_small">
						...
						?>
										...
										<li class="nav_item"><a href="lien-he.html" title="Liên hệ">Liên hệ</a></li>
									</ul>
								</nav>
								<!-- header nav -->
							</div>
				...
				<div class="navbar_mobile lg_hidden">
					<ul class="ul_collections">
						...
						<li class="parent">
							<a href="gioi-thieu.html">Giới thiệu</a></i>
						</li>
						<li class="parent">
		...
		<?php 
	        ...
	        $typep_mb = "SELECT * FROM type_tour ORDER BY typename DESC";
