<?php 
    ...
    if(isset($_SESSION['user']) && isset($_SESSION['level']))
    {
        ...
        // Bao gồm các tệp header, navbar và left-sidebar
        ...
        if(isset($_GET['id']))
        {
            ...
            $id = $_GET['id'];
            // Lấy thông tin về bài viết cần xóa
            ...
            // Nếu ảnh không phải là ảnh mặc định, thì xóa ảnh đó khỏi thư mục lưu trữ
            if($old_image != "no-image.jpg")
            {
                unlink($target_file);
            }

            // Thêm hành động xóa vào lịch sử
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                            ...
                                                            <?php 
                                                                ...
                                                                if($row_blog2['flag'] == 1)
                                                                {
                                                                    // Nếu đã được duyệt, không được phép sửa hoặc xóa
