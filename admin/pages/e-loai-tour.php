<?php 
    ...
    if(isset($_SESSION['user']) && isset($_SESSION['level']))
    {
        ...
        if(isset($_GET['id']))
        {
            ...
            // Truy vấn để lấy thông tin về loại sản phẩm dựa trên 'id' nhận được
        ...
        if(isset($_POST['save']))
        {
            // Lấy tên loại sản phẩm từ form
            $name_type = $_POST['name_type'];
            $slug = generateURL($name_type);

            // Kiểm tra xem tên loại sản phẩm có được nhập không
            if($name_type)
            {
                ...
                // Cập nhật tên loại sản phẩm trong cơ sở dữ liệu
            ...
            {
                // Hiển thị thông báo nếu tên loại sản phẩm không được nhập
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        <form method="POST">
                                            <div class="form-group">
                                                ...
                                                <!-- Hiển thị tên loại sản phẩm hiện tại -->
