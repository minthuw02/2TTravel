...
?>
	...
	<?php 
		...
		$product_query = "SELECT sku_product, p.image as image, name_product, price FROM product p, type_product tp, account a WHERE p.id_type = tp.id_type AND a.id_acc = p.author AND name_product LIKE '%$key%' AND flag = 1 ORDER BY date_upload DESC LIMIT $start, $limit";
